var mychat = {
    ...
    init: function()
    {
        ...
        //this.server.connect("wss://ecv-etic.upf.edu/node/9000/ws");
    ...
    GetStarted: function ( cas )
    {
        ...
        //return this.myspace;
        //console.log('getstarted promise returned' + mychat.myspace)
    ...
    {
        this.server = new SillyClient();
        this.server.connect("wss://ecv-etic.upf.edu/node/9000/ws", this.myspace.my_room);
        this.server.on_ready = this.ShareID.bind(this);
        this.server.getReport(this.LobbyData.bind(this));
        this.server.on_user_connected = this.RoomEnter.bind(this);
        this.server.on_user_disconnected = this.RoomLeave.bind(this);
        this.server.on_message = this.ReceiveText.bind(this);
        this.server.on_close = this.ConnectionKilled.bind(this);
    },
                ...
                else if (event.key === 'Enter' || cas == '1') 
                {
                    ...
                    if (msg.type === "private") {
                        if (sendToUser.every(sendToUser => clients_info.hasOwnProperty(sendToUser)))
                            { 
                                this.server.sendMessage(msg, sendToUser);
                                //this.mydatabase.content.push(msg); 
